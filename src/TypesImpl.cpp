...
namespace typeutils{
  ...
  TypesUtilsException::TypesUtilsException(const char* errString) : 
                       errorMessage(errString), errorCode(0){}   
  
  TypesUtilsException::TypesUtilsException(string& errString) : 
                       errorMessage(errString), errorCode(0){}   
  
  TypesUtilsException::TypesUtilsException(int errNum, const char* errString) : 
  ...
  template uint16_t        safeSizeRange<uint16_t>(long long, 
                                              long long)       anyexcept;
  template int             safeSizeRange<int>(long long, 
                                              long long)       anyexcept;
  template size_t          safeSizeRange<size_t>(long long, 
                                              long long)       anyexcept;
  template ssize_t         safeSizeRange<ssize_t>(long long, 
                                              long long)       anyexcept;
  ...
  template int             safeInt(ssize_t size)               anyexcept;
